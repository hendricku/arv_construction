    ...
    <>
      ...
      <ProjectsMain>
        ...
        <div className="projects-filter" aria-label="Project categories">
          ...
          <span>Community</span>
          <span>Academic</span>
          <Link href="/projects/design-concepts" className="text-link">Design archive <span aria-hidden="true">{"\u2197"}</span></Link>
        </div>
            ...
            <article key={project.slug}>
              <Link href={`/projects/${project.slug}`} className="projects-list-link" aria-label={`View ${project.title}`}>
                <div className="projects-list-image">
                  ...
                  <span className="projects-list-view-on-image">View project <span aria-hidden="true">{"\u2197"}</span></span>
                </div>
                <div className="projects-list-copy">
                  ...
                  <div className="projects-list-content">
                    ...
                    <span className="projects-list-view">View project <span aria-hidden="true">{"\u2197"}</span></span>
                  </div>
                </div>
              </Link>
            </article>
