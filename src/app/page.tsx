        ...
        <section className="about-story">
          <div className="site-shell about-story-grid">
            ...
            <div className="about-story-copy">
              ...
              <Link href="/about" className="text-link">About ARV ↗</Link>
            </div>
            <div className="about-image"><Image src="/arvcover.jpg" alt="ARV design and construction visual" fill sizes="(max-width: 820px) 92vw, 30vw" /></div>
          </div>
        </section>
